...
manage their household bills  This README would normally document whatever steps are necessary to get the
...
OmniAuth
SSL
Ability to accept online payments (currently planning on using Stripe but open to using another technology)
